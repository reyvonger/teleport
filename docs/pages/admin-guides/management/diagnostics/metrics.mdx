...
You can find a Grafana dashboard template at [examples/grafana/teleport-dashboard.json](https://github.com/gravitational/teleport/blame/branch/v(=teleport.major_version=)/examples/grafana/teleport-dashboard.json).
